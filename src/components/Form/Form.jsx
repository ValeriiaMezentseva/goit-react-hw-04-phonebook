...
const ContactsForm = ({ addContact, contacts, toggle, isOpenContacts, isOpenFilter }) => {
             ...
             <FormWrapper>
                ...
                <Label htmlFor='number'>
                    Number
                     ...
                     <FormButton type="button" onClick={() => toggle('isOpenContacts')} isOpen={isOpenContacts}> {isOpenContacts ? 'Close contacts' : 'Contacts'} </FormButton>
                     <FormButton type="button"  onClick={() => toggle('isOpenFilter')}
        isOpen={isOpenFilter}>{isOpenFilter ? 'Close filter' : 'Search'}</FormButton>
                 </Form>
                 </FormWrapper>
             </Formik>
        )
